...
- [Code Blocks Implementation Documentation](#code-blocks-implementation-documentation)
  - [Overview](#overview)
  ...
  - [Phase 2: Syntax Highlighting](#phase-2-syntax-highlighting)
    ...
    - [Token Types and Colors](#token-types-and-colors)
      - [Python](#python)
  ...
  - [Phase 3: Rendering](#phase-3-rendering)
    ...
    - [Textbox Configuration](#textbox-configuration)
  ...
  - [Integration with Existing Features](#integration-with-existing-features)
    - [Parsing Integration](#parsing-integration)
    - [Content Validation](#content-validation)
    - [Color System Integration](#color-system-integration)
  - [Testing Strategy](#testing-strategy)
    - [Test Coverage (29 tests in `tests/test_code_block_rendering.py`)](#test-coverage-29-tests-in-teststest_code_block_renderingpy)
  ...
  - [Performance Considerations](#performance-considerations)
    ...
    - [Tokenization Performance](#tokenization-performance)
    - [Rendering Performance](#rendering-performance)
    - [Memory Usage](#memory-usage)
  - [Known Limitations](#known-limitations)
    - [1. No Line Numbers](#1-no-line-numbers)
    - [2. Maximum Height Capping](#2-maximum-height-capping)
    - [3. Character-Level Tokenization](#3-character-level-tokenization)
    - [4. Fixed Font](#4-fixed-font)
    - [5. No Copy Button](#5-no-copy-button)
  - [Future Enhancements](#future-enhancements)
    - [Short-term (High Priority)](#short-term-high-priority)
    - [Medium-term (Medium Priority)](#medium-term-medium-priority)
    - [Long-term (Low Priority)](#long-term-low-priority)
  - [Troubleshooting Guide](#troubleshooting-guide)
    - [Issue: Code Not Highlighted](#issue-code-not-highlighted)
    - [Issue: Code Truncated at Bottom](#issue-code-truncated-at-bottom)
    - [Issue: Indentation Lost](#issue-indentation-lost)
    - [Issue: Special Characters Not Displaying](#issue-special-characters-not-displaying)
  - [References](#references)
    - [Code Organization](#code-organization)
    - [Related Documentation](#related-documentation)
    - [External References](#external-references)
  - [Changelog](#changelog)
    - [Version 1.0 (Complete)](#version-10-complete)
